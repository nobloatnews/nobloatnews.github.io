...
if [ $# -lt 1 ]; then
    ...
    echo ""
    echo "NOTA: El video se generará en formato vertical 9:16 para Instagram Reels"
    echo "NOTA: Instagram agregará subtítulos automáticos al publicar"
    exit 1
fi

INPUT_FILE="$1"
BASENAME=$(basename "$INPUT_FILE" .txt)
OUTPUT_VIDEO="${2:-${BASENAME}_reel.mp4}"
...
echo "=== Procesando archivo para Instagram Reel: $INPUT_FILE ==="
...
# ====================================
# PASO 3: Generar timecodes
# ====================================
echo "=== Generando timecodes ==="
...
# ====================================
# PASO 4: Generar video final en formato vertical
# ====================================
echo "=== Generando video con slider ==="
slider -i "$timecodes_file" -a "audio_full.wav" -x "1080x1920" -o "$ORIGINAL_DIR/$OUTPUT_VIDEO"
...
echo ""
echo "=== ¡Completado! ==="
echo "Video para Instagram Reel: $OUTPUT_VIDEO"
echo "Formato: 1080x1920 (9:16 vertical)"
echo "Nota: Instagram agregará subtítulos automáticos al publicar"
echo ""
